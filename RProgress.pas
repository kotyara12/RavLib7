...
type
  ...
  public
    procedure ShowProgress(Sender: TObject; const MsgClass: TRMsgClass;
      const CurrPos, MaxPos: Integer);
    procedure FileProgress(Sender: TObject;
      const CurrPos, MaxPos: Integer);
...
procedure TFormProgress.ShowProgress(Sender: TObject;
  const MsgClass: TRMsgClass; const CurrPos, MaxPos: Integer);
begin
  FileProgress(Sender, CurrPos, MaxPos);
end;
