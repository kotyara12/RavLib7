...
type
  TAuditDbColorDialogTemplate = class(TDbAuditDialogTemplate)
...
procedure TAuditDbColorDialogTemplate.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TAuditDbColorDialogTemplate.InitFormVariables;
begin
  inherited;
  FCellColorField := nil;
  FFontColorField := nil;
...
procedure TAuditDbColorDialogTemplate.InitComponents(const EditMode: Boolean);
begin
  try
    inherited;
  finally
...
procedure TAuditDbColorDialogTemplate.UpdateControls(Sender: TObject);
begin
  inherited;
...
procedure TAuditDbColorDialogTemplate.DecodeColors(Sender: TObject);
begin
  FCellColor := clWindow;
  FFontColor := clWindowText;
  FFontStyle := 0;
...
{ == Смена цвета фона ========================================================== }
procedure TAuditDbColorDialogTemplate.PutCellColor;
begin
...
procedure TAuditDbColorDialogTemplate.SetCellColor(Sender: TObject);
begin
...
procedure TAuditDbColorDialogTemplate.CellColorBtnClick(Sender: TObject);
begin
...
{ == Смена цвета текста ======================================================== }
procedure TAuditDbColorDialogTemplate.PutFontColor;
begin
...
procedure TAuditDbColorDialogTemplate.SetFontColor(Sender: TObject);
begin
...
procedure TAuditDbColorDialogTemplate.FontColorBtnClick(Sender: TObject);
begin
...
{ == Смена стиля шрифта ======================================================== }
procedure TAuditDbColorDialogTemplate.PutFontStyle;
begin
  TestText.Font.Style := [];
  if FontStyleCheckBox.Checked then
  begin
...
procedure TAuditDbColorDialogTemplate.SetFontStyle(Sender: TObject);
begin
...
procedure TAuditDbColorDialogTemplate.SetFontStyleProp(Sender: TObject);
begin
  FFontStyle := 0;
