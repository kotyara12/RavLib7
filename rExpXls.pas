...
uses
  ...
  Grids, RavGrid, Menus, ImgList, ActnList;
...
uses
  IniFiles, RxStrUtils, ExcelConst,
  rVclUtils, rExpXlsParam, rFrmStorage, rMsExcel, rSysUtils,
  rListView, rDialogs, rMsgRu, rProgress;
...
begin
  ...
  LoadListColumns(Self, lvFields, True);
...
begin
  SaveListColumns(Self, lvFields, True);
  ...
  begin
    try
      ...
      try
        ...
        try
          edAlign.Items.Clear;
          edAlign.Items.Add(SAlignmentLeft);
          edAlign.Items.Add(SAlignmentRight);
          edAlign.Items.Add(SAlignmentCenter);
        finally
